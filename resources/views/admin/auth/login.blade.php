...
@section('content')
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
                        ...
                        <div>
                            <form action="{{ route('login.process') }}" method="POST">
                                ...
                                <div class="space-y-5">
                                    @error('email')
                                        <div
                                            class="rounded-xl border p-4 border-red-500 bg-red-50 dark:border-red-500/30 dark:bg-red-500/15">
            ...
            <div class="bg-[#052B35] relative hidden h-full w-full items-center lg:grid lg:w-1/2">
                <div class="z-1 flex items-center justify-center">
                    <!-- ===== Common Grid Shape Start ===== -->
                    <x-common.common-grid-shape />
                    <div class="flex max-w-xs flex-col items-center">
                        <div class="mb-4 block">
                            <img src="/images/front-end/logo2.png" alt="Logo" />
                        </div>
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Admin Company Profile<br>PT FASTLOG ERA MANDIRI
                        </p>
                    </div>
                </div>
            </div>
