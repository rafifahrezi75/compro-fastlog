<header class="sticky top-0 flex w-full bg-white border-gray-200 z-30 dark:border-[#083C4A] dark:bg-[#052B35] xl:border-b"
    x-data="{
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="xl:hidden flex items-center gap-2">
                <img class="dark:hidden h-8 w-auto"
                    src="{{ asset('images/front-end/logo_fastlog_fix_removebg_preview_3-d4-3710_176-t3676_86.webp') }}"
                    width="140" height="30" alt="Logo" />
                <img class="hidden dark:block h-8 w-auto" src="{{ asset('images/front-end/logo2.png') }}" width="140"
                    height="30" alt="Logo" />
                <h1 class="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">
                    Admin Fastlog
                </h1>
            </a>
