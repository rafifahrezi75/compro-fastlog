...
>
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <nav class="flex items-center gap-2 text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">
                <a href="{{ route('dashboard') }}" class="hover:text-brand-500 transition-colors">Dashboard</a>
                <span>/</span>
                <a href="{{ route('master') }}" class="hover:text-brand-500 transition-colors">Master</a>
                <span>/</span>
                <span class="text-gray-900 dark:text-white font-semibold">Berita</span>
            </nav>
            <h1 class="text-xl sm:text-2xl font-bold tracking-tight text-gray-900 dark:text-white flex items-center gap-2.5">
                <span class="p-2 rounded-xl bg-brand-500/10 text-brand-500 dark:bg-brand-500/20">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M19 20H5C3.89543 20 3 19.1046 3 18V6C3 4.89543 3.89543 4 5 4H15L21 10V18C21 19.1046 20.1046 20 19 20Z"></path>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4">
        ...
        <div class="p-4 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm flex items-center gap-3.5">
            ...
            <div class="min-w-0">
                ...
                <h4 class="text-lg sm:text-xl font-bold text-emerald-600 dark:text-emerald-400 mt-0.5" x-text="countPublished()">0</h4>
            </div>
        </div>

        <!-- Berita Draft -->
        <div class="p-4 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm flex items-center gap-3.5">
            <div class="w-11 h-11 rounded-xl bg-amber-50 dark:bg-amber-950/40 text-amber-600 dark:text-amber-400 flex items-center justify-center shrink-0">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Sumber Berita -->
        <div class="p-4 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm flex items-center gap-3.5">
            <div class="w-11 h-11 rounded-xl bg-purple-50 dark:bg-purple-950/40 text-purple-600 dark:text-purple-400 flex items-center justify-center shrink-0">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="min-w-0">
                ...
                <h4 class="text-lg sm:text-xl font-bold text-purple-600 dark:text-purple-400 mt-0.5" x-text="countSources()">0</h4>
            </div>
        </div>
    </div>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 shadow-sm overflow-hidden">
        ...
        <div class="p-4 sm:p-5 border-b border-gray-100 dark:border-gray-800 flex flex-col lg:flex-row gap-3.5 lg:items-center lg:justify-between bg-gray-50/50 dark:bg-white/[0.01]">
            ...
            <div class="relative flex-1 min-w-[240px] max-w-lg">
                ...
                <input
                    type="text" 
                    x-model="searchQuery" 
                    placeholder="Cari judul berita, slug, atau sumber..." 
            ...
            <div class="flex items-center gap-2.5 flex-wrap">
                <!-- Status Filter -->
                <div class="flex items-center gap-1.5 bg-white dark:bg-gray-800/80 border border-gray-200 dark:border-gray-700 rounded-xl px-2.5 py-1.5">
                ...
                <!-- Reset Filter -->
                <button 
                    x-show="searchQuery || selectedStatus !== 'Semua'" 
                    @click="resetFilters()" 
            ...
            <table class="w-full text-left border-collapse table-auto">
                <thead>
                    <tr class="border-b border-gray-100 dark:border-gray-800 bg-gray-50/40 dark:bg-white/[0.02]">
                        <th class="py-3 px-3.5 sm:px-5 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                            Berita & Slug
                        </th>
                        <th class="py-3 px-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider hidden sm:table-cell w-36">
                            Sumber
                        </th>
                        <th class="py-3 px-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider hidden md:table-cell w-36">
                            Tanggal Publikasi
                        </th>
                        <th class="py-3 px-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-center w-28">
                            Status
                        </th>
                        <th class="py-3 px-3.5 sm:px-5 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-right w-24 sm:w-28">
                            Aksi
                        </th>
                    </tr>
                </thead>
                        ...
                        <tr class="hover:bg-gray-50/60 dark:hover:bg-white/[0.02] transition-colors group">
                            ...
                            <td class="py-3.5 px-3.5 sm:px-5">
                                <div class="flex items-start gap-3 min-w-0">
                                    <!-- Image Thumbnail -->
                                    <div class="w-12 h-12 sm:w-14 sm:h-14 rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shrink-0 relative">
                                        ...
                                        <template x-if="!item.gambar_url && !item.gambar">
                                            <div class="w-full h-full flex items-center justify-center text-gray-400 bg-gray-100 dark:bg-gray-800">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <div class="flex items-center gap-2 mt-1.5 flex-wrap">
                                            <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-mono bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700/60 max-w-[200px] sm:max-w-xs truncate">
                            ...
                            <td class="py-3.5 px-3 hidden md:table-cell">
                                <span class="text-xs text-gray-600 dark:text-gray-400" x-text="item.formatted_date || item.created_at || '-'"></span>
                            </td>

                            <!-- Status -->
                            <td class="py-3.5 px-3 text-center">
                                <template x-if="item.status === 'published' || item.status === 'Aktif'">
                                    <span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-medium bg-emerald-50 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800">
                                        <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                                        Published
                                    </span>
                                </template>
                                <template x-if="item.status !== 'published' && item.status !== 'Aktif'">
                                    <span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-medium bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-400 border border-gray-200 dark:border-gray-700">
                        ...
                        <td colspan="5" class="py-12 text-center">
                            <div class="flex flex-col items-center justify-center max-w-sm mx-auto">
                                <div class="w-14 h-14 rounded-2xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-400 mb-3">
                                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 20H5C3.89543 20 3 19.1046 3 18V6C3 4.89543 3.89543 4 5 4H15L21 10V18C21 19.1046 20.1046 20 19 20Z"></path></svg>
                                </div>
        ...
        <div class="p-3.5 sm:p-4 border-t border-gray-100 dark:border-gray-800 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-xs text-gray-500 dark:text-gray-400 bg-gray-50/30 dark:bg-white/[0.01]">
            <div>
                Menampilkan 
                <span class="font-semibold text-gray-900 dark:text-white" x-text="filteredBeritas.length > 0 ? ((currentPage - 1) * perPage) + 1 : 0"></span> - 
                <span class="font-semibold text-gray-900 dark:text-white" x-text="Math.min(currentPage * perPage, filteredBeritas.length)"></span> 
        ...
        >
            ...
            <div class="px-6 py-4.5 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between bg-gray-50/50 dark:bg-white/[0.02]">
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">Lengkapi formulir di bawah ini untuk menerbitkan berita logistik.</p>
                    </div>
                </div>
            ...
            <form @submit.prevent="submitAddBerita()" class="p-6 space-y-4 max-h-[78vh] overflow-y-auto">
                ...
                <div>
                    ...
                    <input 
                        type="text" 
                        x-model="formAdd.judul" 
                        @input="formAdd.slug = generateSlug(formAdd.judul)"
                        placeholder="Contoh: Pembukaan Rute Baru Kargo Maritim Jawa-Papua 2026" 
                        required
                ...
                <div class="space-y-2">
                    ...
                    <input 
                        type="file" 
                        accept="image/*"
                        @change="handleAddImageChange($event)"
                    ...
                    <template x-if="formAdd.imagePreview">
                        <div class="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700 flex items-center gap-3">
                            <img :src="formAdd.imagePreview" class="w-16 h-12 object-cover rounded-lg border border-gray-200 dark:border-gray-600" />
                            <div class="min-w-0 flex-1">
                                <p class="text-xs font-medium text-gray-800 dark:text-gray-200 truncate" x-text="formAdd.imageFileName"></p>
                                <span class="text-[10px] text-emerald-500 font-medium">Gambar siap diunggah</span>
                            </div>
                            <button type="button" @click="formAdd.imagePreview = null; formAdd.imageFile = null" class="text-xs text-rose-500 hover:underline">Hapus</button>
                        </div>
                    </template>
                </div>
        ...
        >
            ...
            <div class="px-6 py-4.5 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between bg-gray-50/50 dark:bg-white/[0.02]">
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">Perbarui informasi, judul, sumber, dan artikel berita.</p>
                    </div>
                </div>
            ...
            <form @submit.prevent="submitEditBerita()" class="p-6 space-y-4 max-h-[78vh] overflow-y-auto">
                ...
                <div>
                    ...
                    <input 
                        type="text" 
                        x-model="formEdit.judul" 
                        @input="formEdit.slug = generateSlug(formEdit.judul)"
                        required
                        class="w-full px-3.5 py-2.5 text-xs sm:text-sm bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 outline-none"
                    />
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700 flex items-center gap-3">
                        <img :src="formEdit.imagePreview || formEdit.existingImageUrl || '/images/cards/card-01.jpg'" class="w-16 h-12 object-cover rounded-lg border border-gray-200 dark:border-gray-600" x-on:error="$event.target.onerror = null; $event.target.src = '/images/cards/card-01.jpg'" />
                        <div class="min-w-0 flex-1">
                            <p class="text-xs font-medium text-gray-800 dark:text-gray-200 truncate" x-text="formEdit.imageFileName || 'Gambar Banner Saat Ini'"></p>
                            <span class="text-[10px] text-gray-500 dark:text-gray-400">Pilih file baru jika ingin mengganti gambar banner</span>
                        </div>
                    </div>
                </div>
            ...
            <template x-if="selectedItem">
                <div>
                    ...
                    <div class="relative h-52 sm:h-64 w-full bg-gray-100 dark:bg-gray-800 overflow-hidden">
                        <img 
                            :src="selectedItem.gambar_url || (selectedItem.gambar ? '/' + selectedItem.gambar : '/images/cards/card-01.jpg')" 
                        ...
                        <div class="absolute bottom-4 left-5 right-5 text-white">
                            <div class="flex items-center gap-2 mb-1.5 flex-wrap">
                                <span class="px-2.5 py-0.5 rounded-full text-[11px] font-medium bg-brand-500 text-white" x-text="selectedItem.status === 'published' ? 'Published' : 'Draft'"></span>
                                <span class="px-2 py-0.5 rounded-md text-[10px] font-mono bg-white/20 backdrop-blur-sm text-gray-100" x-text="'/' + selectedItem.slug"></span>
                            </div>
                            <h2 class="text-base sm:text-xl font-bold leading-tight line-clamp-2" x-text="selectedItem.judul"></h2>
                        </div>
                    </div>
                    ...
                    <div class="p-6 space-y-4 max-h-[50vh] overflow-y-auto">
                        ...
                        <div class="grid grid-cols-2 gap-3 p-3.5 bg-gray-50 dark:bg-gray-800/50 rounded-xl text-xs">
                            <div>
                                ...
                                <span class="font-semibold text-gray-800 dark:text-gray-200" x-text="selectedItem.sumber || 'Humas Fastlog'"></span>
                            </div>
                            <div>
                                <span class="text-gray-400 block mb-0.5">Waktu Rilis:</span>
                                <span class="font-semibold text-gray-800 dark:text-gray-200" x-text="selectedItem.formatted_date || selectedItem.created_at || '-'"></span>
                            </div>
                        </div>

                        <!-- Formatted Content -->
                        <div>
                            <span class="text-xs font-semibold text-gray-400 uppercase tracking-wider block mb-2">Konten Berita:</span>
                            <div 
                                ...
                                x-html="selectedItem.isi"
                            ></div>
                        </div>
                    </div>

                    <!-- Footer -->
                    <div class="px-6 py-4 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between bg-gray-50/50 dark:bg-white/[0.02]">
                        <button 
                            @click="isDetailModalOpen = false; openEditModal(selectedItem)"
    ...
    >
        ...
        >
            <div class="w-12 h-12 rounded-2xl bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400 flex items-center justify-center mx-auto mb-4">
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">
                Apakah Anda yakin ingin menghapus berita <strong class="text-gray-800 dark:text-gray-200" x-text="selectedItem?.judul"></strong>? Berkas gambar dan artikel akan dihapus secara permanen.
            </p>
