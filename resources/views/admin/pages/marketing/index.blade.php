        ...
        <div x-show="isAddModalOpen" x-cloak
            ...
            <div x-show="isAddModalOpen"
                ...
                <form @submit.prevent="submitAdd()" class="p-6 space-y-4">
                    ...
                    <div>
                        <label
                            class="block text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider mb-1.5">Divisi</label>
                        <input type="text" x-model="formAdd.divisi" placeholder="Cth: Marketing Executive"
                            class="w-full px-3.5 py-2.5 text-xs sm:text-sm bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 outline-none" />
                    </div>
                    <div>
                        <label
                            class="block text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider mb-1.5">Nomor
                            WhatsApp <span class="text-rose-500">*</span></label>
                        <input type="text" x-model="formAdd.no_wa" placeholder="Cth: 6281234567890" required
                            class="w-full px-3.5 py-2.5 text-xs sm:text-sm bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 outline-none" />
                        <p class="text-[10px] sm:text-xs text-gray-500 mt-1">Awali dengan kode negara (misal 62) tanpa
                            tanda plus (+).</p>
                    </div>
                    <div>
                        <label
            ...
            <div x-show="isEditModalOpen"
                ...
                <form @submit.prevent="submitEdit()" class="p-6 space-y-4">
                    ...
                    <div>
                        <label
                            class="block text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider mb-1.5">Divisi</label>
                        <input type="text" x-model="formEdit.divisi"
                            class="w-full px-3.5 py-2.5 text-xs sm:text-sm bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 outline-none" />
                    </div>
                    <div>
                        <label
                            class="block text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider mb-1.5">Nomor
                            WhatsApp <span class="text-rose-500">*</span></label>
                        <input type="text" x-model="formEdit.no_wa" required
                            class="w-full px-3.5 py-2.5 text-xs sm:text-sm bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 outline-none" />
                    </div>
                    <div>
                        <label
            ...
            Alpine.data('marketingManager', () => ({
                ...
                async submitEdit() {
                    ...
                    try {
                        ...
                        `{{ url('admin/marketing') }}/${this.formEdit.id}`, {
                            method: 'POST',
                            headers: {
                                'Accept': 'application/json',
                                'X-Requested-With': 'XMLHttpRequest',
