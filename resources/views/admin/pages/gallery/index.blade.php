          ...
          <div class="space-y-2">
            ...
            <div
              ...
              <div class="min-w-0 flex-1">
                ...
                <span class="text-[10px] text-gray-500 dark:text-gray-400">Pilih file baru jika ingin mengganti gambar
                  banner</span>
              </div>
            </div>
          </div>
        ...
        <template x-if="selectedItem">
          <div>
            ...
            <div class="relative h-52 sm:h-64 w-full bg-gray-100 dark:bg-gray-800 overflow-hidden">
              <img
                :src="selectedItem.gambar_url || (selectedItem.gambar ? '/' + selectedItem.gambar :
              ...
              <div class="absolute bottom-4 left-5 right-5 text-white">
                <div class="flex items-center gap-2 mb-1.5 flex-wrap">
                  <span class="px-2.5 py-0.5 rounded-full text-[11px] font-medium bg-brand-500 text-white"
                    x-text="selectedItem.status === 'published' ? 'Published' : 'Draft'"></span>
                  <span class="px-2 py-0.5 rounded-md text-[10px] font-mono bg-white/20 backdrop-blur-sm text-gray-100"
