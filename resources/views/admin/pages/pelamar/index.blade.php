        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1">
                    Kelola berkas kandidat pelamar yang masuk dari formulir karir, evaluasi CV, dan pembaruan status
                    seleksi.
                </p>
            </div>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4">
            ...
            <div
                ...
                <div class="min-w-0">
                    ...
                    <h4 class="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mt-0.5" x-text="pelamars.length">0
                    </h4>
                </div>
            </div>
        ...
        <div
            ...
            <div
                ...
                <div class="flex items-center gap-2.5 flex-wrap justify-end">
                    ...
                    <!-- Reset Filter -->
                    <button x-show="searchQuery || selectedStatus !== 'Semua' || selectedPosisi !== 'Semua'"
                        @click="resetFilters()"
                            ...
                            <tr class="hover:bg-gray-50/70 dark:hover:bg-gray-800/40 transition-colors">
                                ...
                                <td class="py-3.5 px-3.5 sm:px-5 min-w-[220px]">
                                    <div class="flex items-start gap-3">
                                        <div class="w-9 h-9 rounded-xl bg-brand-50 dark:bg-brand-500/10 text-brand-600 dark:text-brand-400 flex items-center justify-center shrink-0 mt-0.5 font-bold text-sm border border-brand-200/50 dark:border-brand-500/20"
                                        ...
                                        <div>
                                            <h4 @click="openDetailModal(item)"
                                                ...
                                                x-text="item.nama"></h4>
                                            <div
                                                class="flex flex-col sm:flex-row sm:items-center gap-x-2 text-xs text-gray-400 dark:text-gray-500 mt-0.5">
                                                <span x-text="item.email"></span>
                                                <span class="hidden sm:inline">•</span>
                                                <span class="font-mono text-gray-600 dark:text-gray-300"
                                                    x-text="item.telepon"></span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                    ...
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <div class="flex items-center gap-1.5">
                                            <span
                                                ...
                                                <span
                                                    x-text="getApplicantCountForPosition(item.posisi) + ' Orang Mendaftar'"></span>
                                            </span>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="py-3.5 px-3.5 sm:px-5 text-center whitespace-nowrap">
                                    <span
                                        class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-medium border"
                                        :class="getStatusBadgeClass(item.status)">
                                        <span class="w-1.5 h-1.5 rounded-full"
                                            :class="getStatusDotClass(item.status)"></span>
                                ...
                                <td class="py-3.5 px-3.5 sm:px-5 text-right whitespace-nowrap">
                                    <div class="flex items-center justify-end gap-1">
                                        <!-- Chat WhatsApp -->
                                        <a :href="'https://wa.me/' + cleanPhone(item.telepon)" target="_blank"
                                            title="Hubungi Pelamar via WhatsApp"
                                        ...
                                        <button @click="openDetailModal(item)" type="button"
                        ...
                        <tr x-show="filteredPelamars.length === 0">
                            <td colspan="7" class="py-12 text-center">
                                <div class="flex flex-col items-center justify-center max-w-sm mx-auto">
                                    ...
                                    <h4 class="text-sm font-semibold text-gray-900 dark:text-white">Tidak Ada Data Pelamar
                                    </h4>
            ...
            <div
                ...
                <div>
                    ...
                    dari <span class="font-semibold text-gray-900 dark:text-white"
                        x-text="filteredPelamars.length"></span>
                    pelamar
                </div>
                ...
                <template x-if="selectedItem">
                    <div>
                        ...
                        <div
                            ...
                            <div class="flex items-start gap-3">
                                <div class="w-11 h-11 rounded-xl bg-brand-500/10 text-brand-500 flex items-center justify-center font-bold text-lg shrink-0 mt-0.5"
                        ...
                        <div class="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
                            ...
                            <div
                                class="p-4 rounded-xl bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700/60 space-y-2.5 text-xs">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center gap-2">
                                            <span class="font-semibold text-gray-800 dark:text-gray-200"
                                                x-text="selectedItem.telepon"></span>
                                ...
                                <div
                                    class="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 border-t border-gray-200 dark:border-gray-700">
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-brand-600 dark:text-brand-400"
                                            x-text="getApplicantCountForPosition(selectedItem.posisi) + ' Orang Mendaftar'">
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div>
                                <h4
                                    class="text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider mb-1.5">
                                    Pesan / Surat Pengantar Kandidat
                                </h4>
                                <div class="p-3.5 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-xs sm:text-sm text-gray-600 dark:text-gray-300 leading-relaxed italic"
                            ...
                            <form @submit.prevent="submitUpdateStatus()"
                                class="space-y-3.5 pt-3 border-t border-gray-100 dark:border-gray-800">
                                <div>
                                    <label
        ...
        function pelamarManager() {
            return {
                ...
                getApplicantCountForPosition(posisiName) {
                    ...
                    return this.pelamars.filter(p => p.posisi && p.posisi.trim().toLowerCase() === posisiName.trim()
                        .toLowerCase()).length;
                },
                ...
                get filteredPelamars() {
                    return this.pelamars.filter(item => {
                        ...
                        const matchStatus = this.selectedStatus === 'Semua' || item.status === this
                            .selectedStatus;
                        const matchPosisi = this.selectedPosisi === 'Semua' || item.posisi === this
                            .selectedPosisi;
