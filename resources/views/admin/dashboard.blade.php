...
@section('content')
    <div class="space-y-6 max-w-full overflow-x-hidden" x-data="dashboardAnalytics()">
        ...
        <!-- ========================================================================= -->
        <div
            class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#052B35] via-[#083C4A] to-[#0A4D5E] p-6 sm:p-8 text-white shadow-md">
            <div class="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <div class="flex items-center gap-2 mb-2">
                        <span
                            class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-white/10 backdrop-blur-md text-[#FF7A3D] border border-white/10">
                    ...
                    <p class="mt-1 text-xs sm:text-sm text-white/80 max-w-2xl leading-relaxed">
                        Pantau ringkasan performa publikasi website, lamaran karir masuk, aktivitas tim marketing, dan
                        interaksi klien secara real-time.
                    </p>
                </div>
            ...
            <div class="absolute -right-10 -bottom-10 w-64 h-64 rounded-full bg-[#FF7A3D]/10 pointer-events-none blur-2xl">
            </div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3.5 sm:gap-4">
            ...
            <div
                class="p-4 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col justify-between hover:shadow-md transition">
                <div class="flex items-center justify-between">
                    <span class="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Pelamar
                        Kerja</span>
                    <div
                        class="w-9 h-9 rounded-xl bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 flex items-center justify-center">
            ...
            <div
                class="p-4 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col justify-between hover:shadow-md transition">
                <div class="flex items-center justify-between">
                    <span class="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Lowongan
                        Karir</span>
                    <div
                        class="w-9 h-9 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
            ...
            <div
                class="p-4 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col justify-between hover:shadow-md transition">
                <div class="flex items-center justify-between">
                    <span class="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Berita
                        Publikasi</span>
                    <div
                        class="w-9 h-9 rounded-xl bg-purple-50 dark:bg-purple-950/40 text-purple-600 dark:text-purple-400 flex items-center justify-center">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                d="M19 20H5C3.89543 20 3 19.1046 3 18V6C3 4.89543 3.89543 4 5 4H15L21 10V18C21 19.1046 20.1046 20 19 20Z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M15 4V10H21" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M7 13H13" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M7 17H17" />
                        </svg>
                    </div>
                </div>
                <div class="mt-3">
            ...
            <div
                class="p-4 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col justify-between hover:shadow-md transition">
                <div class="flex items-center justify-between">
                    <span class="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Tim
                        Marketing</span>
                    <div
                        class="w-9 h-9 rounded-xl bg-orange-50 dark:bg-orange-950/40 text-[#FF7A3D] flex items-center justify-center">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                ...
                <div class="mt-3">
                    ...
                    <p
                        class="text-[11px] text-emerald-600 dark:text-emerald-400 font-medium mt-0.5 flex items-center gap-1">
            ...
            <div
                class="p-4 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col justify-between hover:shadow-md transition">
                <div class="flex items-center justify-between">
                    <span class="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Testimoni
                        Klien</span>
                    <div
                        class="w-9 h-9 rounded-xl bg-teal-50 dark:bg-teal-950/40 text-teal-600 dark:text-teal-400 flex items-center justify-center">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
            ...
            <div
                class="p-4 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col justify-between hover:shadow-md transition">
                <div class="flex items-center justify-between">
                    <span class="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Galeri
                        Foto</span>
                    <div
                        class="w-9 h-9 rounded-xl bg-pink-50 dark:bg-pink-950/40 text-pink-600 dark:text-pink-400 flex items-center justify-center">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6">
            ...
            <div
                class="lg:col-span-7 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 p-5 sm:p-6 shadow-sm flex flex-col justify-between">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                    ...
                    <div class="flex items-center gap-2 text-xs">
                        <span
                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-blue-50 text-blue-700 dark:bg-blue-950/40 dark:text-blue-400 font-semibold">
                            <span class="w-2 h-2 rounded-full bg-blue-600"></span>
                            Pelamar
                        </span>
                        <span
                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-purple-50 text-purple-700 dark:bg-purple-950/40 dark:text-purple-400 font-semibold">
            ...
            <div
                class="lg:col-span-5 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 p-5 sm:p-6 shadow-sm flex flex-col justify-between">
                ...
                <div class="grid grid-cols-3 gap-2 pt-3 border-t border-gray-100 dark:border-gray-800 text-[11px]">
                    <div
                        class="p-2 rounded-xl bg-amber-50 dark:bg-amber-950/30 text-amber-800 dark:text-amber-400 text-center">
                        <span class="block font-semibold">Pending</span>
                        <strong class="text-sm font-bold">{{ $statusPelamarCounts['Pending'] }}</strong>
                    </div>
                    <div
                        class="p-2 rounded-xl bg-purple-50 dark:bg-purple-950/30 text-purple-800 dark:text-purple-400 text-center">
                        <span class="block font-semibold">Wawancara</span>
                        <strong
                            class="text-sm font-bold">{{ $statusPelamarCounts['Wawancara'] + $statusPelamarCounts['Review'] }}</strong>
                    </div>
                    <div
                        class="p-2 rounded-xl bg-emerald-50 dark:bg-emerald-950/30 text-emerald-800 dark:text-emerald-400 text-center">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6">
            ...
            <div
                class="lg:col-span-7 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden flex flex-col justify-between">
                <div
                    class="p-4 sm:p-5 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between bg-gray-50/50 dark:bg-white/[0.01]">
                    <div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr
                                class="border-b border-gray-100 dark:border-gray-800 text-[11px] font-semibold tracking-wider text-gray-500 dark:text-gray-400 uppercase bg-gray-50/30 dark:bg-white/[0.01]">
                                ...
                                <tr class="hover:bg-gray-50/60 dark:hover:bg-gray-800/40 transition">
                                    <td class="py-3 px-4">
                                        <div class="flex items-center gap-2.5">
                                            <div
                                                class="w-8 h-8 rounded-full bg-brand-50 text-brand-600 dark:bg-brand-500/10 dark:text-brand-400 flex items-center justify-center font-bold text-xs shrink-0">
                                    ...
                                    <td class="py-3 px-3">
                                        <span
                                            class="font-medium text-gray-800 dark:text-gray-200 block truncate max-w-[150px]">{{ $pelamar->posisi }}</span>
                                        <span
                                            class="text-[10px] text-gray-400">{{ $pelamar->created_at->diffForHumans() }}</span>
                                    </td>
                                    ...
                                    <td class="py-3 px-4 text-right">
                                        <div class="flex items-center justify-end gap-1.5">
                                            @if ($pelamar->file_cv)
                                                <a href="{{ route('admin.pelamar.cv', $pelamar->id) }}" target="_blank"
                                                    title="Unduh CV"
            ...
            <div
                class="lg:col-span-5 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden flex flex-col justify-between">
                <div
                    class="p-4 sm:p-5 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between bg-gray-50/50 dark:bg-white/[0.01]">
                    <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6">
            ...
            <div
                class="lg:col-span-6 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
                <div
                    class="p-4 sm:p-5 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between bg-gray-50/50 dark:bg-white/[0.01]">
                    <div>
                        <h3 class="text-base font-bold text-gray-900 dark:text-white">Tim Marketing Fastlog</h3>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Status online & hotline WhatsApp
                            customer</p>
                    </div>
                ...
                <div class="p-4 space-y-3">
                    @forelse($marketings as $marketing)
                        <div
                            class="p-3 rounded-xl bg-gray-50/75 dark:bg-gray-800/40 border border-gray-100 dark:border-gray-800 flex items-center justify-between gap-3">
                            <div class="flex items-center gap-3 min-w-0">
                                <div
                                    class="w-10 h-10 rounded-full overflow-hidden shrink-0 border border-gray-200 dark:border-gray-700 bg-gray-100 flex items-center justify-center font-bold text-gray-700 dark:text-gray-300">
                                    @if ($marketing->foto)
                                        <img src="{{ asset('storage/' . $marketing->foto) }}"
                                            alt="{{ $marketing->nama }}" class="w-full h-full object-cover">
                                    @else
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-[11px] text-gray-400 truncate">
                                        {{ $marketing->divisi ?? 'Marketing Executive' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-2 shrink-0">
                                @if ($marketing->status === 'online')
                                    <span
                                        class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-semibold bg-emerald-50 text-emerald-600 dark:bg-emerald-950/40 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800">
                                        <span class="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
                                        Online
                                    </span>
                                @else
                                    <span
                                        class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-semibold bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-400 border border-gray-200">
                                        Offline
                                    </span>
                                @endif
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Artikel dan pengumuman terbaru Fastlog
                        </p>
                    </div>
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3 min-w-0">
                                <div class="w-12 h-10 rounded-lg overflow-hidden shrink-0 bg-gray-200">
                                    @if ($news->gambar)
                                        <img src="{{ str_starts_with($news->gambar, 'uploads/') ? asset($news->gambar) : asset('storage/' . $news->gambar) }}"
                                            alt="{{ $news->judul }}" class="w-full h-full object-cover">
                                    @else
                                        <div
                                ...
                                <div class="min-w-0">
                                    <h4 class="font-semibold text-gray-900 dark:text-white text-xs sm:text-sm truncate">
                                        {{ $news->judul }}</h4>
                                    <p class="text-[11px] text-gray-400 truncate">
                                        {{ $news->created_at ? $news->created_at->translatedFormat('d M Y') : '-' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="shrink-0">
                                @if ($news->status === 'published')
                                    <span
                                        class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold bg-emerald-50 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-400 border border-emerald-200">
                                        Published
                                    </span>
                                @else
                                    <span
                                        class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold bg-amber-50 text-amber-700 dark:bg-amber-950/40 dark:text-amber-400 border border-amber-200">
                                        Draft
                                    </span>
                                @endif
                            </div>
