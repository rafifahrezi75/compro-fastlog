...
<section class="relative h-[250px] md:h-[300px] flex items-center justify-center pt-20">
    <div class="absolute inset-0">
        <img src="{{ asset('images/hero-cargo.jpg') }}" alt="Destinasi" class="w-full h-full object-cover">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div class="lg:col-span-3 space-y-10">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-4 leading-relaxed">
                        Layanan pengiriman kargo ekspor-impor dan distribusi logistik terintegrasi menuju dan dari {{ $countryName }}. Kami menjamin efisiensi alur logistik dengan jaringan agen global dan armada terpercaya.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div class="bg-gray-50 border border-gray-100 rounded-2xl p-5 text-center shadow-sm">
                        <p class="text-gray-500 text-xs font-semibold uppercase tracking-wider">Performa Pengiriman</p>
                        <h4 class="text-2xl font-bold text-[#00A884] mt-1">98.5%</h4>
                        <p class="text-xs text-gray-400 mt-1">On-Time Delivery Rate</p>
                    </div>
                    <div class="bg-gray-50 border border-gray-100 rounded-2xl p-5 text-center shadow-sm">
                        <p class="text-gray-500 text-xs font-semibold uppercase tracking-wider">Estimasi Waktu</p>
                        <h4 class="text-2xl font-bold text-[#FF7A3D] mt-1">22 - 28 Hari</h4>
                        <p class="text-xs text-gray-400 mt-1">Transit Time</p>
                    </div>
                    <div class="bg-gray-50 border border-gray-100 rounded-2xl p-5 text-center shadow-sm">
                        <p class="text-gray-500 text-xs font-semibold uppercase tracking-wider">Total Kargo 2025</p>
                        <h4 class="text-2xl font-bold text-[#052B35] mt-1">1,450+ TEUs</h4>
                        <p class="text-xs text-gray-400 mt-1">Volume Kontainer Terkirim</p>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm space-y-6">
                    <div class="flex items-center justify-between border-b pb-4">
                        ...
                        <h3 class="text-lg font-bold text-[#052B35]">Statistik Pengiriman Kargo ({{ $countryName }})</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-700 mb-3 text-center md:text-left">Volume Pengiriman per Kuartal (TEUs)</p>
                            <div class="h-64">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-700 mb-3 text-center md:text-left">Moda Pengiriman Utama</p>
            ...
            <div class="lg:col-span-1 space-y-8">
                ...
                <div class="bg-gray-50 border border-gray-100 rounded-2xl p-6 text-center shadow-sm">
                    <h4 class="text-lg font-bold text-[#052B35] mb-2">Logistics & Cargo for Business</h4>
                    <p class="text-xs text-gray-500 mb-6 leading-relaxed">If you are interested in our services, please feel free to fill inquiry below</p>
