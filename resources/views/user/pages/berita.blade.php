...
{{-- SEO Meta Tags — Halaman Berita --}}
@section('meta_title', 'Berita dan Artikel Logistik Terbaru')
@section('meta_description', 'Ikuti berita, artikel, dan informasi terkini seputar industri logistik, kepabeanan, dan
    freight forwarding dari Fastlog Era Mandiri.')
@section('meta_canonical', route('berita'))
