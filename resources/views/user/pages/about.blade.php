...
{{-- SEO Meta Tags — Halaman Tentang Kami --}}
@section('meta_title', 'Tentang Kami')
@section('meta_description', 'Fastlog Era Mandiri adalah perusahaan logistik Indonesia dengan pengalaman luas di bidang
    Custom Clearance, Freight Forwarding, Reefer Logistic, dan Inland Transport.')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-10">
                ...
                <aside class="lg:col-span-1">
                    ...
                    <nav class="flex flex-col space-y-1">
                        <a href="#"
                            class="px-3 py-2 text-[#FF7A3D] font-semibold border-l-2 border-[#FF7A3D] bg-orange-50/50 transition">
                            {{ __('Vision & Mission') }}
                        </a>
