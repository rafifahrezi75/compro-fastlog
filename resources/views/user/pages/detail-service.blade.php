...
<section class="relative bg-[#052B35] pt-36 pb-16 text-white">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <nav class="flex items-center gap-2 text-sm text-white/70 mb-4">
            ...
            <span>/</span>
            <a href="{{ route('services') }}" class="hover:text-[#FF7A3D] transition">Layanan</a>
            <span>/</span>
        ...
        <p class="text-white/80 max-w-2xl text-base md:text-lg">
            Solusi penanganan logistik terbaik dengan standar operasional internasional untuk menjaga keandalan bisnis Anda.
        </p>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                    <h2 class="text-2xl font-bold text-[#052B35] mb-4">Deskripsi Layanan</h2>
                    <p class="text-gray-600 leading-relaxed text-base mb-6">
                        {{ $service['desc'] }}
                    </p>
                    <p class="text-gray-600 leading-relaxed text-base">
                        PT Fastlog Era Mandiri memastikan setiap tahapan operasional {{ strtolower($service['title']) }} berjalan secara transparan, akurat, dan efisien. Didukung oleh tim ahli berpengalaman serta jaringan armada yang kuat, kami siap meminimalkan risiko pengiriman Anda.
                    </p>
                </div>

                {{-- Fitur / Keunggulan Layanan --}}
                <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                    <h2 class="text-2xl font-bold text-[#052B35] mb-6">Cakupan & Keunggulan</h2>
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                    <h3 class="text-lg font-bold text-[#052B35] mb-4 border-b pb-3">Layanan Lainnya</h3>
                    <ul class="space-y-2">
                        <li>
                ...
                <div class="bg-[#052B35] text-white rounded-2xl p-6 shadow-md relative overflow-hidden">
                    ...
                    <h3 class="text-xl font-bold mb-3">Butuh Konsultasi Layanan Ini?</h3>
                    <p class="text-white/80 text-sm mb-6 leading-relaxed">
                        Hubungi tim marketing kami untuk mendapatkan konsultasi gratis dan penawaran harga terbaik.
                    </p>
