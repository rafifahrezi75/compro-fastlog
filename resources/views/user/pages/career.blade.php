...
{{-- SEO Meta Tags — Halaman Karir --}}
@section('meta_title', 'Lowongan Kerja Logistik dan Freight Forwarding')
@section('meta_description', 'Bergabunglah dengan tim Fastlog Era Mandiri. Temukan lowongan kerja di bidang logistik,
    custom clearance, dan freight forwarding dengan jenjang karir yang jelas.')
@section('meta_canonical', route('career'))
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="flex items-start gap-4">
                    <div
                        class="w-12 h-12 bg-[#FF7A3D]/10 text-[#FF7A3D] rounded-xl flex items-center justify-center shrink-0">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">
                            {{ __('Career development opportunities are wide open based on performance and competence.') }}
                        </p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">
                            {{ __('A work culture that is mutually supportive, professional, and promotes teamwork.') }}
                        </p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">
                            {{ __('Attractive remuneration packages, health insurance, and performance-based incentives.') }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                <div>
                    ...
                    <p class="text-gray-500 text-sm mt-1">
                        {{ __('Choose a position that matches your skills and passion') }}</p>
                </div>
