...
@section('content')
  ...
  <section id="testimonials" class="py-20 bg-slate-50 relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        {{-- Slider / Cards Kanan --}}
        <div class="lg:col-span-7 relative" x-data="{ active: 0, total: 2 }">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div
              class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between min-h-[260px] relative">
              <p class="text-gray-600 text-sm leading-relaxed">
                "Terimakasih buat perusahaan forwarding PT. FASTLOG ERA MANDIRI yang telah memberikan pelayanan yang
                sangat cepat dan prima. Kami sangat puas dan bisa menjadi rekomendasi buat pelaku bisnis ekspor, Impor,
                maupun domestik."
              </p>
              <div class="mt-6 flex items-end justify-between">
                <div>
        ...
        <div class="lg:col-span-5 flex flex-col justify-center space-y-4">
          ...
          <div
            ...
            <div class="flex items-center gap-4">
              ...
              <div>
                <h3 class="text-base md:text-lg font-bold text-[#052B35] group-hover:text-[#FF7A3D] transition-colors">
                  Wivin Winarsihi</h3>
          ...
          <div
            ...
            <a href="https://wa.me/62881036793063" target="_blank" title="Chat Via WhatsApp"
              ...
              <svg class="w-6 h-6 fill-current text-green-400 hover:text-white transition-colors" viewBox="0 0 24 24">
                <path
                  d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654z" />
              </svg>
            </a>
          </div>
  ...
  <{{-- ============ NEWS SECTION (SLIGHTLY COMPACT) ============ --}} <section id="news" class="py-14 bg-white">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
