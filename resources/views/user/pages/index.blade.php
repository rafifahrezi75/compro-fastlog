...
<section class="relative h-[550px] overflow-hidden"
    ...
    <template x-for="(slide, index) in slides" :key="index">
        <div class="absolute inset-0 transition-opacity duration-1000"
            ...
            <img :src="`{{ asset('images/front-end') }}/${slide.image}`" alt="Cargo Solutions" class="w-full h-full object-cover">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 rounded-2xl overflow-hidden shadow-xl">
            ...
            <div class="bg-white p-6 flex gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-sm mb-3 leading-relaxed">
                        Sea freight, air freight, FCL, LCL, ex-work, pengiriman ulang antar pulau. Mencakup seluruh pengiriman logistik
                    </p>
                    <a href="#services" class="inline-flex items-center gap-2 text-[#FF7A3D] font-semibold text-xs hover:gap-3 transition-all">
                        Explore More
            ...
            <div class="bg-[#083C4A] p-6 flex gap-4">
                ...
                <div>
                    ...
                    <a href="#destination" class="inline-flex items-center gap-2 text-[#FF7A3D] font-semibold text-xs hover:gap-3 transition-all">
                        Explore More
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                        </svg>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative">
                ...
                <div class="absolute -bottom-8 left-0 md:left-8 bg-[#052B35] rounded-2xl px-8 py-7 shadow-xl grid grid-cols-3 gap-6 w-[calc(100%-2rem)] md:w-auto">
                    <div>
            ...
            <div class="mt-10 lg:mt-0">
                ...
                <a href="#services" class="inline-block bg-[#FF7A3D] hover:bg-orange-600 text-white font-semibold text-sm px-8 py-4 rounded-xl transition">
                    Explore More
                </a>
            </div>
...
<section id="why-us" class="relative py-24 bg-fixed bg-center bg-cover" style="background-image: url('{{ asset('images/front-end/fastlog2.jpg') }}')">
    {{-- Overlay gelap --}}
    ...
    <div class="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            @foreach ($whyChooseUs as $item)
                <div class="bg-white/10 backdrop-blur-sm border border-white/10 p-6 rounded-2xl hover:bg-white/15 transition text-center">
            ...
            @php
                $layanan = [
                    [
                        ...
                        'desc' => 'Kami memiliki ahli yang memahami betul seluruh peraturan dan prosedur kepabeanan baik untuk ekspor dan impor.',
                        'bg' => 'fastlog1.png',
                        'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75l1.5 1.5 3-3" />',
                    ],
                    [
                        'title' => 'Reefer Logistic',
                        'desc' => 'Mencakup seluruh pengiriman logistik berpendingin termasuk restuffing dalam keadaan beku.',
                        'bg' => 'fastlog2.jpg',
                        'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M8 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM19 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5h1.5m0 0V7a1 1 0 011-1h9.5a1 1 0 011 1v2m-11.5 7.5h8m0 0V9m0 7.5h3m2.5 0H17m2.5 0V11a1 1 0 00-1-1h-3" />',
                    ],
                    [
                        'title' => 'Freight Forwarding',
                        'desc' => 'Menyediakan layanan sea freight, air freight, FCL, LCL, ex-work, pengiriman ulang antar pulau.',
                        'bg' => 'fastlog3.png',
                        'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l1.5-4.5h16.5l1.5 4.5m-19.5 0v3a1.5 1.5 0 001.5 1.5h16.5a1.5 1.5 0 001.5-1.5v-3m-19.5 0h19.5M6 11.25V6a1.5 1.5 0 011.5-1.5h9A1.5 1.5 0 0118 6v5.25" />',
                    ],
                    [
                        'title' => 'Inland Transport',
                        'desc' => 'Pengiriman dalam dan luar pulau melalui berbagai jalur pengiriman menggunakan kapal, truk dan kereta api.',
                        'bg' => 'fastlog1.png',
                        'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M3.375 4.5C2.339 4.5 1.5 5.34 1.5 6.375V13.5h12V6.375c0-1.036-.84-1.875-1.875-1.875h-8.25zM12 9.75V13.5m0 0V17.25a2.25 2.25 0 002.25 2.25h.75m-3-2.25v-5.25m0 0h1.5m3.75 5.25a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-9.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0" />',
                    ],
                ];
            @endphp
            ...
            @foreach ($layanan as $item)
                <div class="group relative rounded-2xl border border-gray-100 overflow-hidden cursor-pointer h-72">
                    ...
                    <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                        <img src="{{ asset('images/front-end/' . $item['bg']) }}" alt="{{ $item['title'] }}" class="w-full h-full object-cover">
                        <div class="absolute inset-0 bg-[#052B35]/75"></div>
                    </div>

                    {{-- Content --}}
                    <div class="relative p-8 h-full flex flex-col">
                        <svg class="w-10 h-10 text-[#FF7A3D] group-hover:text-white transition-colors duration-300 mb-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            {!! $item['icon'] !!}
                        </svg>
                        ...
                        <a href="#" class="mt-auto inline-flex items-center gap-2 text-[#FF7A3D] group-hover:text-white font-semibold text-sm transition-colors duration-300">
                            Read More
