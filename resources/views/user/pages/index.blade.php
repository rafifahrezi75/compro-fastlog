        ...
        startAutoplay();" @mouseenter="stopAutoplay()" @mouseleave="startAutoplay()">
            ...
            <div class="flex justify-center gap-4 mt-10">
                <button @click="prev(); stopAutoplay(); startAutoplay()"
                    class="w-11 h-11 rounded-full border border-gray-300 flex items-center justify-center text-gray-500 hover:border-[#FF7A3D] hover:text-[#FF7A3D] transition">
                                    ...
                                    <div
                                        ...
                                        <div class="mt-auto pt-6 flex items-end justify-between">
                                            <div class="flex items-center gap-3">
                                                {{-- Foto --}}
                                                @if ($item->foto)
                                                    <img src="{{ str_starts_with($item->foto, 'uploads/') ? asset($item->foto) : asset('storage/' . $item->foto) }}"
                                                        alt="{{ $item->nama }}"
                                                ...
                                                @else
                                                    <div
                                                        class="w-10 h-10 rounded-full bg-[#052B35] text-white flex items-center justify-center font-bold text-sm shrink-0">
                                            ...
                                            <span
                                                class="text-5xl font-serif text-[#FF7A3D]/40 font-bold leading-none shrink-0"
                    ...
                    @forelse($marketings as $marketing)
                        <div
                            ...
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-16 h-16 rounded-full overflow-hidden shrink-0 border-2 border-slate-100 group-hover:border-[#FF7A3D]/30 transition-all duration-300 flex items-center justify-center bg-gray-50 text-gray-400 font-bold text-xl">
                                    @if ($marketing->foto)
                            ...
                            <a href="https://wa.me/{{ $marketing->no_wa }}" target="_blank" title="Chat Via WhatsApp"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                @forelse($beritas as $news)
                    <a href="{{ route('berita.detail', $news->slug) }}"
                        class="group rounded-xl overflow-hidden border border-gray-100 hover:shadow-lg transition block flex flex-col">
