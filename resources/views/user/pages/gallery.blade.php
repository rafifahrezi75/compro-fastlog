...
<section class="relative h-[300px] md:h-[350px] flex items-center justify-center pt-20">
    <div class="absolute inset-0">
        <img src="{{ asset('images/hero-cargo.jpg') }}" alt="Galeri" class="w-full h-full object-cover">
        <div class="absolute inset-0 bg-[#052B35]/70"></div>
    </div>

    <div class="relative z-10 text-center text-white px-4 mt-8">
        <h1 class="text-3xl md:text-5xl font-bold mb-3">Galeri</h1>
...
{{-- ============ MAIN CONTENT GALERI (INTERAKTIF) ============ --}}
...
<section class="py-16 bg-white" x-data="{ openModal: false, activeImage: '', activeTitle: '', activeDesc: '' }">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        @php
            $galleries = [
                [
                    ...
                    'desc' => 'Kegiatan outbond tahunan untuk mempererat keakraban dan kerja sama antar karyawan PT. Fastlog Era Mandiri.',
                    'image' => 'gallery-1.jpg'
                ],
                [
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach ($galleries as $item)
                <div @click="openModal = true; activeImage = '{{ asset('images/' . $item['image']) }}'; activeTitle = '{{ $item['title'] }}'; activeDesc = '{{ $item['desc'] }}'"
                    ...
                    {{-- Overlay Gradient --}}
                    <div class="absolute inset-0 bg-gradient-to-t from-[#052B35]/80 via-transparent to-transparent opacity-80 group-hover:opacity-100 transition duration-300"></div>
                    ...
                    <div class="absolute bottom-0 left-0 p-6 w-full flex items-end justify-between">
                        ...
                        <div class="w-9 h-9 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center text-white group-hover:bg-[#FF7A3D] transition">
    ...
    <div x-show="openModal" 
        ...
        {{-- Konten Card Modal --}}
        <div class="relative bg-white rounded-2xl overflow-hidden max-w-3xl w-full z-10 shadow-2xl transform transition-all">
