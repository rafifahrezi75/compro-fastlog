                ...
                <div class="flex items-center justify-between h-20 sm:h-24">
                    ...
                    <div class="flex items-center gap-8">
                        <nav class="flex items-center gap-7">
                            <a href="{{ route('home') }}"
                                class="text-[15px] font-medium transition duration-200 {{ request()->routeIs('home') ? 'text-[#FF7A3D]' : 'text-white hover:text-[#FF7A3D]' }}">Home</a>
                            <a href="{{ route('about') }}"
                                class="text-[15px] font-medium transition duration-200 {{ request()->routeIs('about*') ? 'text-[#FF7A3D]' : 'text-white hover:text-[#FF7A3D]' }}">Tentang
                                Kami</a>
                            ...
                            <a href="{{ route('berita') }}"
                                class="text-[15px] font-medium transition duration-200 {{ request()->routeIs('berita*') ? 'text-[#FF7A3D]' : 'text-white hover:text-[#FF7A3D]' }}">Berita</a>
                            <a href="{{ route('career') }}"
                        ...
                        <a href="{{ route('contact') }}"
                            class="bg-[#FF7A3D] hover:bg-orange-600 text-white px-6 py-3 rounded-xl font-semibold text-sm transition duration-300 shadow-md whitespace-nowrap">Contact
                            Us</a>
                    </div>
        ...
        <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="p-6">
                ...
                <nav class="flex flex-col space-y-4 font-semibold uppercase tracking-wider text-sm">
                    <a href="{{ route('home') }}"
                        class="py-2 border-b border-white/5 text-white hover:text-[#FF7A3D]">HOME</a>
                    <a href="{{ route('about') }}"
                        class="py-2 border-b border-white/5 text-white hover:text-[#FF7A3D]">TENTANG KAMI</a>
                    <a href="{{ route('services') }}"
                        class="py-2 border-b border-white/5 text-white hover:text-[#FF7A3D]">LAYANAN</a>
                    <a href="{{ route('destination') }}"
                        class="py-2 border-b border-white/5 text-white hover:text-[#FF7A3D]">DESTINASI</a>
                    <a href="{{ route('gallery') }}"
                        class="py-2 border-b border-white/5 text-white hover:text-[#FF7A3D]">GALERI</a>
                    <a href="{{ route('berita') }}"
                        class="py-2 border-b border-white/5 text-white hover:text-[#FF7A3D]">BERITA</a>
                    <a href="{{ route('career') }}"
                        class="py-2 border-b border-white/5 text-white hover:text-[#FF7A3D]">KARIR</a>
                </nav>
