...
<header id="main-header" class="fixed top-0 left-0 w-full z-50 transition-all duration-300">
    ...
    {{-- 1. TOP BAR INFO --}}
    <div id="top-bar" class="bg-[#052B35] text-white text-xs sm:text-sm py-2.5 border-b border-white/10 transition-all duration-300 overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between">
            ...
            <div class="flex items-center bg-white/10 rounded-lg p-1 space-x-1">
                <a href="?lang=id"
                    ...
                    <svg class="w-4 h-4 rounded-sm shadow-sm" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex items-center space-x-6 text-xs sm:text-sm">
                <div class="flex items-center space-x-1.5">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-white shrink-0" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
                    </svg>
                    <span>Surabaya, Indonesia</span>
                </div>

                <a href="mailto:admin@fastlogem.co.id" class="hidden sm:flex items-center space-x-1.5 hover:text-[#FF7A3D] transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-white shrink-0" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="flex items-center justify-between h-24">
                ...
                <a href="{{ route('home') }}" class="flex items-center">
                    <img src="{{ asset('images/fastloglogo.png') }}"
                        alt="Fastlog Era Mandiri"
                        class="h-16 w-auto object-contain">
                </a>

                <nav class="flex items-center space-x-9">
    <a href="{{ route('home') }}" class="text-white text-lg font-medium hover:text-[#FF7A3D] transition duration-200">Home</a>
    <a href="#about" class="nav-item text-white text-lg font-medium hover:text-[#FF7A3D] transition duration-200">Tentang Kami</a>

    {{-- Dropdown Layanan --}}
    <div class="relative group">
        <a href="#services" class="nav-item text-white text-lg font-medium hover:text-[#FF7A3D] transition duration-200 flex items-center gap-1">
            Layanan
    ...
    <a href="#destination" class="nav-item text-white text-lg font-medium hover:text-[#FF7A3D] transition duration-200">Destinasi</a>
    <a href="#gallery" class="nav-item text-white text-lg font-medium hover:text-[#FF7A3D] transition duration-200">Galeri</a>

    {{-- Dropdown Berita --}}
    <div class="relative group">
        <a href="#news" class="nav-item text-white text-lg font-medium hover:text-[#FF7A3D] transition duration-200 flex items-center gap-1">
            Berita
            <svg class="w-4 h-4 transition-transform group-hover:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
            </svg>
        ...
        <div class="absolute left-0 top-full pt-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 w-56">
            <div class="bg-[#052B35] rounded-xl shadow-xl border-t-2 border-[#FF7A3D] py-3">
                <a href="#news" class="block px-5 py-2.5 text-white/90 hover:text-[#FF7A3D] hover:bg-white/5 transition">Berita</a>
                <a href="#news" class="block px-5 py-2.5 text-white/90 hover:text-[#FF7A3D] hover:bg-white/5 transition">Detail Berita</a>
            </div>
        </div>
    </div>

    <a href="#career" class="nav-item text-white text-lg font-medium hover:text-[#FF7A3D] transition duration-200">Karir</a>
</nav>

                    <a href="#contact" class="bg-[#FF7A3D] hover:bg-orange-600 text-white px-8 py-4 rounded-xl font-semibold transition duration-300 shadow-md whitespace-nowrap">
                        Contact Us
                    </a>
                </div>
    ...
    <div id="mobile-menu" class="hidden lg:hidden bg-[#052B35] border-t border-white/10">
        <div class="flex flex-col p-6 space-y-5">
            ...
            <a href="#gallery" class="nav-item-mobile text-white hover:text-[#FF7A3D]">Galeri</a>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div class="md:col-span-1">
                <img src="{{ asset('images/logo_fastlog.png') }}" alt="Fastlog Era Mandiri" class="h-14 mb-4">
                <p class="text-white/60 text-sm mb-5">
                    World Leading Contract Logistics Provider
                </p>
                <div class="flex gap-3">
                    <a href="#" class="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#FF7A3D] transition">
                        <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c5.05-.5 9-4.76 9-9.95z"/></svg>
                    </a>
                    <a href="#" class="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#FF7A3D] transition">
                        <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10-4.48-10-10-10zm5 6.5c0 .28-.22.5-.5.5h-1.75c-.83 0-1.25.42-1.25 1.25v1.25h2.75l-.4 2.75h-2.35v7h-2.75v-7h-1.75v-2.75h1.75V9.5c0-1.93 1.32-3.5 3.5-3.5h1.75c.28 0 .5.22.5.5v1.5z"/></svg>
                    </a>
                    <a href="#" class="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#FF7A3D] transition">
                        <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M19 3a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h14zM8.34 18v-8.4H5.67V18h2.67zM7 8.48a1.55 1.55 0 100-3.1 1.55 1.55 0 000 3.1zM18.34 18v-4.63c0-2.48-1.32-3.63-3.08-3.63-1.42 0-2.06.78-2.4 1.33V9.6H10.2c.03.7 0 8.4 0 8.4h2.66v-4.7c0-.25.02-.5.1-.68.2-.5.66-1.02 1.44-1.02.99 0 1.44.75 1.44 1.86V18h2.5z"/></svg>
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <a href="mailto:admin@fastlogem.co.id" class="block text-white/60 hover:text-[#FF7A3D] text-sm mb-1 transition">admin@fastlogem.co.id</a>
